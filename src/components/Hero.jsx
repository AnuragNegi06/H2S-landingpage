...
function Hero(){
    return (
                ...
                <div className=" flex-col h-screen w-full bg-[url('assets/images/bg1.jpg')] bg-cover bg-center text-white gap-30 ">
                ...
                <div className="flex justify-between top-20  h-90 w-screen bg-black/0 p-10 pt-100">
                    <div>
                        ...
                        <img src="src/assets/images/model.png" alt="model_photo" className="absolute h-130 z-1 right-5 bottom-1"/>
