function Navbar(){
    return (
        ...
        <div className="flex justify-between items-center bg-white absolute p-5 ml-150 mr-80 mt-20 h-17 rounded-4xl text-black gap-10">
            <div className="flex justify-center p-1 h-10 w-20 "><img src="src/assets/images/logo.png" className="object-cover p-1"/></div>
